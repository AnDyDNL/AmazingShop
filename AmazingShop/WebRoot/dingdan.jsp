			...
			<div class="show">
				...
				<c:forEach items="${orderlist}" var="orderlist" varStatus="statuts">
					<div class="show_shop_cart" id="show_${statuts.count}">
						...
						<div class="delete">
							<span class="sp01"></span><a href="javascript:void(0);" onclick="remove(${statuts.count})">删除</a></span><br>
							<span class="spcdw01"></span><a href="${pageContext.request.contextPath }/xiangQingServlet?id=${orderlist.goods_id}">评价</a></span>
						</div>
					</div>
